event zeek_init() {
    ...
    local result3 = Matchy::query_ip(db, 8.8.8.8);
    if (result3 != "") {
    ...
    local result4 = Matchy::query_string(db, "malware.example.com");
    if (result4 == "") {
    ...
    local result5 = Matchy::query_string(db, "sub.evil.com");
    if (result5 == "") {
    ...
    local result6 = Matchy::query_string(db, "google.com");
    if (result6 != "") {
    ...
    print "\n8. Database will be automatically unloaded";
